...
async fn main() {
    ...
    assert_eq!(
        ...
        "StructUnnamed(42, [\"string0\", \"string1\"], [0, 1], 999)",
    );
    ...
    assert_eq!(
        ...
        "StructNamed { string: \"test\", rw_lock: [\"string0\", \"string1\"], mutex: [0, 1], mutex_u128: 999 }",
    );
    ...
    assert_eq!(
        ...
        "Variant1 { string: \"test\", rw_lock: [\"string0\", \"string1\"], mutex: [0, 1], mutex_u128: 999 }",
    );
    ...
    assert_eq!(
        ...
        "Variant2 { v2_rw_lock: [\"string0\", \"string1\"], v2_mutex: [0, 1], v2_mutex_u128: 999 }",
    );
    ...
    assert_eq!(
        ...
        "Variant1(\"test\", [\"string0\", \"string1\"], [0, 1], 999)",
    );
    ...
    assert_eq!(
        ...
        "Variant2([\"string0\", \"string1\"], [0, 1], 999)",
    );
}
